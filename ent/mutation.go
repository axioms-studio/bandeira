...
func (m *ApiTokenMutation) SetCreatedBy(i int) {
	m.creator = &i
}

// CreatedBy returns the value of the "created_by" field in the mutation.
func (m *ApiTokenMutation) CreatedBy() (r int, exists bool) {
	v := m.creator
	if v == nil {
		return
	}
...
// If the ApiToken object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApiTokenMutation) OldCreatedBy(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApiTokenMutation) SetCreatorID(id int) {
	m.creator = &id
}

// ClearCreator clears the "creator" edge to the User entity.
func (m *ApiTokenMutation) ClearCreator() {
	m.clearedcreator = true
	m.clearedFields[apitoken.FieldCreatedBy] = struct{}{}
}

// CreatorCleared reports if the "creator" edge to the User entity was cleared.
func (m *ApiTokenMutation) CreatorCleared() bool {
	return m.CreatedByCleared() || m.clearedcreator
}

// CreatorID returns the "creator" edge ID in the mutation.
func (m *ApiTokenMutation) CreatorID() (id int, exists bool) {
	if m.creator != nil {
...
func (m *ApiTokenMutation) CreatorIDs() (ids []int) {
...
func (m *ApiTokenMutation) ResetCreator() {
	m.creator = nil
...
func (m *ApiTokenMutation) AddedEdges() []string {
	...
	if m.creator != nil {
		edges = append(edges, apitoken.EdgeCreator)
	}
	return edges
}
