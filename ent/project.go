...
// was not loaded in eager-loading.
func (e ProjectEdges) FlagsOrErr() ([]*Flag, error) {
	if e.loadedTypes[1] {
		return e.Flags, nil
	}
...
// QueryFlags queries the "flags" edge of the Project entity.
func (_m *Project) QueryFlags() *FlagQuery {
	return NewProjectClient(_m.config).QueryFlags(_m)
}
